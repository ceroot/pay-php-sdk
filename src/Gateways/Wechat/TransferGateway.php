...
class TransferGateway extends Wechat
{
    ...
    public function apply(array $options = [])
    {
        ...
        $options['mch_appid'] = $this->config['appid'];
        ...
        $data = $this->fromXml($this->post($this->gateway, $this->toXml($this->config), ['cert' => $this->userConfig->get('cert_client', ''), 'ssl_key' => $this->userConfig->get('cert_key', '')]));
